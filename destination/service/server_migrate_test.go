...
func TestHandleDropOperation_DefaultEntity(t *testing.T) {
	resp := handleDropOperation(context.Background(), nil, "schema", "table", &pb.DropOperation{})
...
func TestHandleCopyOperation_DefaultEntity(t *testing.T) {
	resp := handleCopyOperation(context.Background(), nil, "schema", "table", &pb.CopyOperation{})
	assert.NotNil(t, resp.GetTask())
...
func TestHandleRenameOperation_DefaultEntity(t *testing.T) {
	resp := handleRenameOperation(context.Background(), nil, "schema", "table", &pb.RenameOperation{})
	assert.NotNil(t, resp.GetTask())
...
func TestHandleAddOperation_DefaultEntity(t *testing.T) {
	resp := handleAddOperation(context.Background(), nil, "schema", "table", &pb.AddOperation{})
	assert.NotNil(t, resp.GetTask())
...
func TestHandleTableSyncModeMigration_UnsupportedLiveTransitions(t *testing.T) {
	...
	for _, mt := range unsupportedTypes {
		t.Run(mt.String(), func(t *testing.T) {
			resp := handleTableSyncModeMigration(context.Background(), nil, "schema", "table",
...
func TestHandleUpdateColumnValue_MissingColumn(t *testing.T) {
	resp := handleUpdateColumnValue(context.Background(), nil, "schema", "table",
