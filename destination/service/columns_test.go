...
func TestToFivetranColumns(t *testing.T) {
	...
	assert.Equal(t, cols, []*pb.Column{
		...
		{Name: "dec", Type: pb.DataType_DECIMAL, PrimaryKey: false,
			Params: &pb.DataTypeParams{Params: &pb.DataTypeParams_Decimal{Decimal: &pb.DecimalParams{Precision: 10, Scale: 4}}}},
